function [ tsWARFIMA ] = MultiBiVARFIMA( MaternCov , prFit , Copula , m , eventDuration , K )
...
% RHO13 = coef(9);
% RHO23 = coef(10);
[ WAR_norm , IMF_norm] = MultiBivariateMaternSim( N1 , N2 , A , N12 , RHO12 , max(eventDuration,1024) , K );
