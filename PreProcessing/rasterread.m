...
%     indicating location and name of the file, e.g. 'srtm.txt'.
% 
...
for r = 1:nrnames ;
	...
	header.(names{find(I)}) = str2double(headernum);
end
%% read raster data
